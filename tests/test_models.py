...
from models.test_models import StreamConfig, PathsConfig, AuthConfig, RTSPConfig
...
class TestStreamConfig:
    ...
    def test_invalid_timeout_format(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            StreamConfig(runOnDemand="ffmpeg", runOnDemandStartTimeout="invalid")
    ...
    def test_extra_fields_allowed(self):
        ...
        config = StreamConfig(source="rtsp://test", customField="customValue")
...
class TestPathsConfig:
    ...
    def test_add_stream(self):
        ...
        paths = PathsConfig()
        paths.add_stream("stream1", {"source": "rtsp://test", "rtspTransport": "tcp"})
    ...
    def test_to_dict(self):
        ...
        paths.add_stream(
            "stream1",
            {"source": "rtsp://test", "rtspTransport": "tcp", "sourceOnDemand": True},
        )
